 function levelOne(){
  ...
  if(frameCount%enemyRate === 0){
    ...
    var currentGrid = noteGrid1 [gridPosition]
    ...
    //set the speed on first number and direction of the enemy on last number
    enemy.setSpeed(5,90);
    ...
    gridPosition++;
    gridPosition = gridPosition%(noteGrid1.length);
